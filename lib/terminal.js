...
import { prepareSshAuth, sshAuthMethod, sshInvocation, sshShellPathPrefix } from './ssh.js';
...
export async function startTerminalSession(remote) {
  ...
  spec.env = { ...spec.env, ...auth.env };
  spec.cleanup = auth.cleanup;
