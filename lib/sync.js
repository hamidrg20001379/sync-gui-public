      ...
      for (const ti of targetIndices) {
        ...
        for (const remote of remotes) {
          ...
          const result = remote.kind === 'ssh'
            ? await syncSsh({ item, target, remote, direction, dryRun, noDelete, restrictToChangedFiles })
            : await syncLocal({ item, target, remote, direction, dryRun, noDelete, restrictToChangedFiles });
...
async function syncSsh({ item, target, remote, direction, dryRun, noDelete, restrictToChangedFiles }) {
...
async function syncLocal({ item, target, remote, direction, dryRun, noDelete, restrictToChangedFiles }) {
